                            ...
                            <div class="row">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <select class="form-control selectric" name="country" id="country">
                                            ...
                                            <?php foreach ($countries as $country) : ?>
                                                <option value="<?= $country['country_id'] ?>" <?= $country['country_id'] ==  $user['country_id'] ? 'selected' : '' ?>><?= $country['country_name'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-floating mb-3">
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input type="url" class="form-control" id="website_url" name="website_url" placeholder="https://www.google.com" value="<?= $user['website_url'] ?? '' ?>">
                                    </div>
                                    <div class="form-floating mb-3">
                                        ...
                                        <select class="form-control selectric" name="acc_status" id="acc_status">
                                            ...
                                            <?php foreach ($statusesdb as $status) : ?>
                                                <?php if (strtolower($status['status_type']) == 'active' or strtolower($status['status_type']) == 'suspended') : ?>
                                                    <option value="<?= $status['status_id'] ?>" <?= $status['status_id'] ==  $user['acc_status'] ? 'selected' : '' ?>><?= ucwords($status['status_type']) ?></option>
                                                <?php endif ?>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
