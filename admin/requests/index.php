...
$donations_query = 'SELECT users.*, posts.*, blood_groups.*, blood_processes.*, statuses.*, countries.* FROM posts
...
try {
    ...
    // This block will catch any Exception or its subclasses that were thrown inside the try block
    echo "An error occurred: " . $e->getMessage();
}
?>

<!-- table for request posts -->
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Request Posts Details</div>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    if ($counter > 0) {
                                        foreach ($result as $row) {
                                            ...
                                            echo '<button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage</button>';
                                            ...
                                            if ($row['status_type'] == 'pending') {
                                                ...
                                                echo '<button class="btn-sm btn btn-warning dropdown-toggle" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">More</button>';
                                                echo '<div class="dropdown-menu">';
