...
$requests_query = 'SELECT users.*, posts.*, blood_groups.*, blood_processes.*, statuses.*, countries.*
    FROM posts
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="../requests/">Requests</a></div>
            <div class="breadcrumb-item">Requests Posts Details</div>
        </div>
    </div>
